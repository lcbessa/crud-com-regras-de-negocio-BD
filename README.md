...
6. **Testar Endpoints**: Utilize o arquivo [testes_insomnia.json](https://github.com/lcbessa/crud-com-regras-de-negocio-BD/blob/master/testes_insomnia.json) que contém os endpoints para teste. Esse arquivo pode ser importado diretamente no Insomnia para facilitar a execução dos testes.
